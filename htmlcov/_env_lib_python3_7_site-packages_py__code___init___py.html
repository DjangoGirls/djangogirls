...
<head>
    ...
    <title>Coverage for .env/lib/python3.7/site-packages/py/_code/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>.env/lib/python3.7/site-packages/py/_code/__init__.py</b> :
