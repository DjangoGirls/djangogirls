...
<head>
    ...
    <title>Coverage for .env/lib/python3.7/site-packages/suit/models.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>.env/lib/python3.7/site-packages/suit/models.py</b> :
...
<div id="source">
    <p id="t1" class="pln"><span class="n"><a href="#t1">1</a></span><span class="t"><span class="com"># Just an empty models.py file, so that we can run tests</span>&nbsp;</span><span class="r"></span></p>
</div>
<div id="footer">
    <div class="content">
        <p>
