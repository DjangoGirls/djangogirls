# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-12-16 18:55
...
class Migration(migrations.Migration):
    ...
    replaces = [('organize', '0001_squashed_0004_remove_eventapplication_rejection_reason'), ('organize', '0002_auto_20170108_1421'), ('organize', '0003_auto_20170115_1523'), ('organize', '0004_auto_20170116_1808'), ('organize', '0005_auto_20170120_1810'), ('organize', '0006_auto_20170507_2202')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('website_slug', autoslug.fields.AutoSlugField(editable=True, populate_from='city')),
                ...
                ('status', models.CharField(choices=[('new', 'New'), ('in_review', 'In review'), ('on_hold', 'On hold'), ('accepted', 'Accepted'), ('rejected', 'Rejected'), ('deployed', 'Deployed')], default='new', max_length=10)),
