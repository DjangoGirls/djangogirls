...
change_status_to_on_hold.short_description = _("Move selected application to on hold")
...
change_status_to_in_review.short_description = _("Move selected application to in review")
