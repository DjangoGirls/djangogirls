...
class EventAdminTestCase(BaseCoreTestCase):
    ...
    def setUp(self):
        ...
        self.peter.user_permissions = [
            Permission.objects.get_or_create(codename='add_event')[0],
            Permission.objects.get_or_create(codename='change_event')[0]
        ]
        self.peter.save()
    ...
    def test_adding_organizer_as_superuser(self):
        ...
        resp = self.client.post(
            reverse('admin:core_event_add_organizers'), data)
