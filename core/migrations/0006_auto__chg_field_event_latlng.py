...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.latlng'
        db.alter_column(u'core_event', 'latlng', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):

        # Changing field 'Event.latlng'
        db.alter_column(u'core_event', 'latlng', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
