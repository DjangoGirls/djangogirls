...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_event', 'date', self.gf('django_date_extensions.fields.ApproximateDateField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Event.date'
        db.alter_column(u'core_event', 'date', self.gf('django.db.models.fields.DateField')(null=True))
