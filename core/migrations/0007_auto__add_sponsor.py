...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_sponsor', (
            ...
            ('event_page_content', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.EventPageContent'])),
    ...
    models = {
        ...
        u'core.event': {
            ...
            'date': ('django_date_extensions.fields.ApproximateDateField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_on_homepage': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'latlng': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
        ...
        u'core.sponsor': {
            'Meta': {'ordering': "('position',)", 'object_name': 'Sponsor'},
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'event_page_content': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.EventPageContent']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
