...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventPage.url'
        db.add_column(u'core_eventpage', 'url',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Event.url'
        db.delete_column(u'core_event', 'url')


    def backwards(self, orm):
        # Deleting field 'EventPage.url'
        db.delete_column(u'core_eventpage', 'url')

        # Adding field 'Event.url'
        db.add_column(u'core_event', 'url',
                      self.gf('django.db.models.fields.CharField')(default='europython', max_length=200),
                      keep_default=False)
