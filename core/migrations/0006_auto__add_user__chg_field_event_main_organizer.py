...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.main_organizer'
        db.alter_column(u'core_event', 'main_organizer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.main_organizer'
        db.alter_column(u'core_event', 'main_organizer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
