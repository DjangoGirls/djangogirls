...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.is_on_homepage'
        db.add_column(u'core_event', 'is_on_homepage',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.is_on_homepage'
        db.delete_column(u'core_event', 'is_on_homepage')
