    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('submitted', 'Application submitted'), ('accepted', 'Application accepted'), ('rejected', 'Application rejected'), ('waitlisted', 'Application on waiting list'), ('declined', 'Applicant declined')], default='submitted', max_length=50, null=True, verbose_name='State of the application')),
                ('email', models.EmailField(blank=True, max_length=254, null=True)),
                ('newsletter_optin', models.BooleanField(default=False)),
                ('rsvp_status', models.CharField(choices=[('waiting', 'RSVP: Waiting for response'), ('yes', 'RSVP: Confirmed attendance'), ('no', 'RSVP: Rejected invitation')], default='waiting', max_length=50, verbose_name='RSVP status')),
