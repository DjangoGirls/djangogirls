...
class ApplicationsDownloadView(TestCase):
    ...
    def test_download_applications_list(self):
        ...
        self.assertEquals(len(csv_list[1]), 5)
        self.assertEquals(csv_list[0][0], "Application Number")
        self.assertEquals(csv_list[1][2], "submitted")
        self.assertEquals(csv_list[2][2], "accepted")
        self.assertEquals(csv_list[3][2], "rejected")
        self.assertEquals(csv_list[4][2], "waitlisted")
